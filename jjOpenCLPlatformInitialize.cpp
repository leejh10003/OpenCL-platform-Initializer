						   ...
						   int index)
{
	 ...
	 */
	char* macroToString = NULL;//This variable store Error Message's platform's property name. This variable is set by below's switch statement
	...
	{
		case CL_PLATFORM_NAME: macroToString = "NAME";
							   informationToKnow = &(input->platforms[index].clPlatformName);
							   break;
		case CL_PLATFORM_VENDOR: macroToString = "VENDOR";
								 informationToKnow = &(input->platforms[index].clVendor);
								 break;
		case CL_PLATFORM_VERSION: macroToString = "VERSION";
								  informationToKnow = &(input->platforms[index].clVersion);
								  break;
		case CL_PLATFORM_PROFILE: macroToString = "PROFILE";
			 					  informationToKnow = &(input->platforms[index].fullSupportOrNot);
			 					  break;
		case CL_PLATFORM_EXTENSIONS: macroToString = "EXTENSIONS";
